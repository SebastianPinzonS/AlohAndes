...
public class SQLReserva 
{
	...
	{
        Query q = pm.newQuery(SQL, "INSERT INTO RESERVA (id_reserva,id_oferta, id_cliente, precio_especial_tomado, reserva_colectiva, fecha_realizacion_reserva,fecha_inicial,duracion_dias) VALUES (?, ?, 1, 0, 0, CURRENT_DATE, ?, ?)");
