...
import uniandes.isis2304.alohandes.negocio.VOHotel;
...
//			e.printStackTrace();
    ...
    public void demoDarBebedorCompleto ( )
    {
		try 
		{
			...
			List <VOBar> listaBares = parranderos.darVOBares ();
			List <VOBebedor> bebedores = parranderos.darVOBebedores();
			List <VOHotel> listaGustan = parranderos.darVOGustan();
...
//			e.printStackTrace();
     ...
     */
    private String listarGustan (List<VOHotel> lista) 
    {
    	String resp = "Los gustan existentes son:\n";
    	int i = 1;
        for (VOHotel serv : lista)
        {
